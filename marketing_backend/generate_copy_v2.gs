...
口吻：溫和介紹、不催促、不打折扣。重點是「讓家長認識太平新光分校」。
寫作目標：建立品牌印象，引發好奇。`;
...
要寫：催促家長把握早鳥。`;
  ...
  const sys = [
    '你是台灣兒童美語+科學夏令營「太平新光分校」的社群行銷文案師。',
    '品牌口吻：溫暖、專業、家長感、清晰可讀。',
  ...
  const userPrompt = [
    ...
    `2. body（內文）：${isReel ? '60-80' : '90-130'} 字，第二人稱對家長說話，帶課程主題與太平新光價值`,
    '3. hashtags（5 個）：#太平新光 + 3 個跟主題相關的，空格分隔',
